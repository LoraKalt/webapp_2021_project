...
router.post("/changepassword", usersController.authRequired, usersController.validateChangePassword, usersController.changePassword, commonController.redirectView);
